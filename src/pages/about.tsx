  ...
  return (
    <PublicLayout>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {/* Story Text */}
            <div className="flex flex-col items-start gap-6 text-right animate-fade-in-up" style={{ animationDelay: '100ms' }}>
            ...
            {/* Visual Block */}
            <div className="p-8 bg-indigo-900 text-indigo-100 rounded-2xl shadow-lg flex flex-col justify-center gap-6 relative overflow-hidden animate-fade-in-up" style={{ animationDelay: '200ms' }}>
      ...
      <section className="py-20 bg-slate-50 border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 animate-fade-in-up" style={{ animationDelay: '300ms' }}>

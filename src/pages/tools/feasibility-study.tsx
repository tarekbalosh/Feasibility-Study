...
/**
 * صفحة أداة دراسة الجدوى (Landing).
 * هذا هو محتوى الصفحة الرئيسية السابق، نُقل كما هو إلى مسار الأداة
 * بعد تحويل الموقع إلى منصة أدوات متعددة.
 */
const START_PATH = getToolStartPath("feasibility-study");

export default function FeasibilityStudyLanding() {
  return (
    <PublicLayout>
      <Head>
        <title>أداة دراسة الجدوى الذكية | Feasibility Suite</title>
        <meta
          name="description"
          content="أنشئ دراسة جدوى احترافية لمشروعك في دقائق: تحليل السوق، قائمة الدخل التقديرية، التدفقات النقدية، نقطة التعادل، ومؤشرات العائد — متوافقة مع متطلبات البنوك."
        />
        <link
          rel="canonical"
          href="https://feasibilitysuite.com/tools/feasibility-study"
        />
      </Head>
